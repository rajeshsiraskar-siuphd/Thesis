...
While being academically grounded, our research is primarily directed toward the industrial practitioners. We investigate whether reinforcement learning (RL) can produce practical tool-replacement policies for industrial milling equipment. A trained reinforcement learning agent learns to estimate the remaining useful life of the tool during the machining operation, online, and then predict the maintenance action. 
